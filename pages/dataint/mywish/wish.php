...
$link=@mysql_connect('qdm15352744.my3w.com:3306','qdm15352744','liangguang008') or mysql_connect('localhost','root','admin');
mysql_query("set names 'utf8'");
mysql_select_db('qdm15352744_db');
...
switch($act){
	case 'add':
		...
		$i_sql="INSERT INTO  `qdm15352744_db`.`wish` (`ID` ,`username` ,`content`,`time`) VALUES (NULL ,  '".$username."',  '".$content."',".time().")";
		mysql_query($i_sql);
